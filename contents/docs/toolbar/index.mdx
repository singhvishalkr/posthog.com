...
## View surveys in the toolbar

The toolbar enables you to browse your existing [surveys](/docs/surveys) directly from your website.

Click the **Surveys** button in the toolbar to see a list of your surveys. Each survey displays its current status (draft or running).

Use the search field at the top of the list to find specific surveys.

Click on a survey to open it in the PostHog app, where you can view its details, edit it, or analyze responses.

This is useful for checking which surveys are running on a page or navigating to a survey's settings while viewing your live site.
