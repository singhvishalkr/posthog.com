...
## Organizing insights with tags

Tags let you categorize and filter saved insights by team, project, or any grouping you choose. Add tags when saving an insight or from the insights list page.

### Adding tags in bulk

To tag multiple insights at once:

1. Go to the [insights list](https://app.posthog.com/saved_insights).
2. Select the insights you want to tag using the checkboxes.
3. Click **Add tags** in the toolbar.
4. Choose existing tags or create new ones.
