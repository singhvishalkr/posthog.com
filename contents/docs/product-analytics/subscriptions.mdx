...
To view and manage all your subscriptions in one place, open the command menu (Cmd+K on Mac, Ctrl+K on Windows/Linux) and search for "subscriptions", or go directly to `/subscriptions` in your browser.

The subscriptions page lists all your subscriptions in a paginated table. You can filter by:

- **Resource type** – Insights or dashboards
- **Creator** – Who created the subscription
- **Target type** – Email, Slack, or webhook

You can also delete subscriptions from this page. Deleted subscriptions can be restored briefly via an undo option.

## Creating a subscription

To create a new subscription, open the dropdown menu in the top right of any insight or dashboard and click **Subscribe**.
