...
Tags let you categorize and filter dashboards by team, project, or any other grouping. Add tags from a dashboard's sidebar or the dashboards list page.

### Adding tags in bulk

To tag multiple dashboards at once:

1. Go to the [dashboards list](https://app.posthog.com/dashboard).
2. Select the dashboards you want to tag using the checkboxes.
