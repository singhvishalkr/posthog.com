...
> This feature is available for everyone, and doesn't require a Teams or an Enterprise plan. Trend, funnel, and SQL insights (with series breakdowns) support this feature.
...
To change a result's color, click the color icon next to it in the **Detailed results** table (or in the series legend for SQL insights), then select a new color.
