...
- **Feature flags** – See how different flag variants affect retention. Useful for measuring the retention impact of features you're rolling out or running experiments on.
