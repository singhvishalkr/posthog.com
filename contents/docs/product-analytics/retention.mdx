...
You can break down your retention numbers and graph by various properties to see how retention varies across different segments:

| Name              | Description                                                                                                                                                 |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Event properties  | Properties from the start or return event, like browser, device type, or UTM parameters                                                                     |
| Person properties | Properties associated with users, like job title, company, or signup date                                                                                   |
| Feature flags     | See how different [feature flag](/docs/feature-flags) variants affect retention. Useful for measuring the retention impact of features you're rolling out. |
| Group properties  | Analyze B2B or account-level retention. Requires [group analytics](/docs/product-analytics/group-analytics).                                                |
| Cohorts           | Filter to pre-defined groups of users                                                                                                                       |

For example, breaking down by **Country Name** shows which countries have higher retention for a feature.
