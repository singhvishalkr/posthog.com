...
4. Select one or more **support channels** – messages posted in any of these channels automatically become tickets
...
|---------|-------------|---------|
| **Support channels** | Every top-level message in any of these channels becomes a ticket. Thread replies sync as ticket messages. | – |
...
The channel selector shows all public and private channels the SupportHog bot can access. Pick one or more to use as your support inboxes.

The SupportHog bot must be invited to every channel you select – messages in channels where the bot isn't present won't create tickets.
