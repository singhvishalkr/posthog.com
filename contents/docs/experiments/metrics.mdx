...
#### Setting a team-level default

To automatically enable this setting for new experiments, go to **Settings > Experiments** and enable **Require completed conversion window**. New experiments will inherit this default, but you can still override it per experiment in the experiment's Settings tab.
