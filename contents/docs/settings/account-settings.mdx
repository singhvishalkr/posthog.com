...
Connected apps are third-party OAuth applications – like Claude Code, Cursor, or other development tools – that you've authorized to access your PostHog account. These apps use OAuth tokens to interact with PostHog on your behalf.

To view your connected apps, go to [your account settings](https://us.posthog.com/settings/user) and find the **Connected apps** section. Here you can see each authorized app, its verification status, the scopes it has access to, and when you authorized it.

### Revoking access

To revoke an app's access, click **Revoke** next to it. This removes all active tokens for that app, immediately preventing it from accessing your account. If you want to use the app again later, you'll need to re-authorize it.
