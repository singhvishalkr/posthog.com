...
| snowflake_ingested_at | `TIMESTAMP` | The timestamp when the event was loaded into Snowflake                    |
...
CREATE TABLE IF NOT EXISTS "{database}"."{schema}"."{table_name}" (
    ...
    "site_url" STRING,
    "timestamp" TIMESTAMP,
    "snowflake_ingested_at" TIMESTAMP
)
...
|         "snowflake_ingested_at" TIMESTAMP_NTZ(9)                                                                 |
