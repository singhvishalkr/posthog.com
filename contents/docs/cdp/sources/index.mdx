...
## Monitoring webhook sources

For sources using [webhook sync](#webhook), the **Webhook** tab shows success and failure rates. Check it to verify your webhook is receiving data and debug any issues.
