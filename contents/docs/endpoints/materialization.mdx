...
- **The insight uses cohort breakdowns** - Cohort breakdowns produce complex queries that cannot be properly reconstructed from materialized data.
- **The insight uses compare mode** - Compare mode doubles the series count in a way that cannot be reliably materialized.
