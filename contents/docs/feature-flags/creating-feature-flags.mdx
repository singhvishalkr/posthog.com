...
To add tags to multiple feature flags at once:

1. Go to the [feature flags tab](https://app.posthog.com/feature_flags) in PostHog.
2. Use the checkboxes to select the flags you want to tag.
3. Click the **Tags** button that appears in the toolbar.
4. Select the tags you want to apply to all selected flags.

This adds tags to all selected flags without removing existing tags. It's helpful for organizing flags by team, project, or release cycle as your flag count grows.

Selections persist across pages, so you can select flags from multiple pages before applying tags.
